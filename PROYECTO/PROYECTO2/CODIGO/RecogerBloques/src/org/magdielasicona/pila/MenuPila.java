...
public class MenuPila extends javax.swing.JFrame {
    ...
    public MenuPila() {
        ...
        this.setTitle("AGREGAR MENU PILA");
        ListaPila.getInstancia().obtenerAreaPila(jTextAreaPila);
    ...
    private void initComponents() {
        ...
        jTextAreaPila = new javax.swing.JTextArea();
        ...
        jTextAreaPila.setColumns(20);
        jTextAreaPila.setRows(5);
        jScrollPane1.setViewportView(jTextAreaPila);

        jButtonAgregar.setText("PUSH");
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(jButtonRegresar, javax.swing.GroupLayout.PREFERRED_SIZE, 93, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void jButtonAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAgregarActionPerformed
        AgregarPila agre = new AgregarPila();
        agre.setVisible(true);
        dispose();
    }//GEN-LAST:event_jButtonAgregarActionPerformed

    private void jButtonEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEliminarActionPerformed
        jTextAreaPila.setText("");
        ListaPila.getInstancia().retirarPila();
        ListaPila.getInstancia().imprimirArea();
    ...
    private javax.swing.JTextArea jTextAreaPila;
